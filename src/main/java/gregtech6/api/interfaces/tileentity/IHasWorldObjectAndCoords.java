...
//  public IGregTech6TileEntity getIGregTech6TileEntity(int aX, int aY, int aZ);
//  public IGregTech6TileEntity getIGregTech6TileEntityOffset(int aX, int aY, int aZ);
//  public IGregTech6TileEntity getIGregTech6TileEntityAtSide(byte aSide);
//  public IGregTech6TileEntity getIGregTech6TileEntityAtSideAndDistance(byte aSide, int aDistance);
