...
public class MultiTileEntityMiniPortalCW2AquaCavern extends MultiTileEntityMiniPortal {
	...
	public void addToolTips2(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get("gt.tileentity.portal.aquacavern.tooltip.1"));
		aList.add(Chat.CYAN     + LH.get("gt.tileentity.portal.aquacavern.tooltip.2"));
	...
	public void findTargetPortal() {
		...
		if (worldObj != null && isServerSide()) {
			...
			} else if (WD.dimCW2AquaCavern(worldObj)) {
				long tShortestDistance = 128*128;
	...
	public ITexture sCW2Portal = BlockTextureCopied.get(ST.block(MD.CW2, "aqua_cavern_portal", Blocks.portal), SIDE_ANY, 0, UNCOLOURED, F, T, T), sCW2PortalFrame = BlockTextureCopied.get(Blocks.mossy_cobblestone, SIDE_ANY, 0);
	...
	@Override public String getTileEntityName() {return "gt.multitileentity.portal.aquacavern";}
}
