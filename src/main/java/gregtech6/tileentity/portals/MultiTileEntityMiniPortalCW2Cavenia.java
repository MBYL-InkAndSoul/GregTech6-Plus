 ...
 */
public class MultiTileEntityMiniPortalCW2Cavenia extends MultiTileEntityMiniPortal {
	...
	static {
		LH.add("gt.tileentity.portal.cavenia.tooltip.1", "Only works between Cavenia and the Overworld!");
		LH.add("gt.tileentity.portal.cavenia.tooltip.2", "Margin of Error to still work: 128 Meters.");
	}
	
	@Override
	public void addToolTips2(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get("gt.tileentity.portal.cavenia.tooltip.1"));
		aList.add(Chat.CYAN     + LH.get("gt.tileentity.portal.cavenia.tooltip.2"));
	...
	@Override public String getTileEntityName() {return "gt.multitileentity.portal.cavenia";}
}
