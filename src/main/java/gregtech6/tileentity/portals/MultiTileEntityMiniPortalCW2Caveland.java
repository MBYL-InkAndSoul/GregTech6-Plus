 ...
 */
public class MultiTileEntityMiniPortalCW2Caveland extends MultiTileEntityMiniPortal {
	...
	public void addToolTips2(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get("gt.tileentity.portal.caveland.tooltip.1"));
		aList.add(Chat.CYAN     + LH.get("gt.tileentity.portal.caveland.tooltip.2"));
	...
	public void findTargetPortal() {
		...
		if (worldObj != null && isServerSide()) {
			...
			} else if (WD.dimCW2Caveland(worldObj)) {
				long tShortestDistance = 128*128;
