...
public class MultiTileEntityWeightometerMedium extends MultiTileEntitySensorTE {
	static {LH.add("gt.tooltip.sensor.mediumweightometer", "Measures the weight of an Inventory (in Kilogramme)");}
	@Override public String getSensorDescription() {return LH.get("gt.tooltip.sensor.mediumweightometer");}
