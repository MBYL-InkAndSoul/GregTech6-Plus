...
public class MultiTileEntityWeightometerSuperHeavy extends MultiTileEntitySensorTE {
	static {LH.add("gt.tooltip.sensor.superheavyweightometer", "Measures the weight of an Inventory (in Kilotons)");}
	@Override public String getSensorDescription() {return LH.get("gt.tooltip.sensor.superheavyweightometer");}
	...
	@Override public String getTileEntityName() {return "gt.multitileentity.redstone.sensors.superheavyweightometer";}
}
