	...
	public byte[] transform(String name, String transformedName, byte[] basicClass) {
		...
		for (MethodNode m: classNode.methods) {
			if (m.name.equals("logger")) {
				...
				m.instructions.add(new FieldInsnNode(Opcodes.GETSTATIC, "gregtech6/asm/transformers/MicroBlock_FixLoggerCrash", "FAKE_LOGGER", "Lorg/apache/logging/log4j/Logger;"));
