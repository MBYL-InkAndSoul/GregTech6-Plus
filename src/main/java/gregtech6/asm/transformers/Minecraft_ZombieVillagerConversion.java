	...
	public byte[] transform(String name, String transformedName, byte[] basicClass) {
		...
		for (MethodNode m: classNode.methods) {
			if (m.name.equals("onKillEntity") || (m.name.equals("a") && m.desc.equals("(Lsv;)V"))) {
				...
				m.instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "gregtech6/asm/transformers/minecraft/Replacements", "EntityZombie_onKillEntity", "(Ljava/lang/Object;Ljava/lang/Object;)V", false));
