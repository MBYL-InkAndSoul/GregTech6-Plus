	...
	public byte[] transform(String name, String transformedName, byte[] basicClass) {
		...
		for (MethodNode m: classNode.methods) {
			if (m.name.equals("isFlammable") || m.name.equals("o")) {
				...
				m.instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "gregtech6/asm/transformers/minecraft/Replacements", "BlockStaticLiquid_isFlammable", "(Lnet/minecraft/world/World;III)Z", false));
				...
				m.instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "gregtech6/asm/transformers/minecraft/Replacements", "BlockStaticLiquid_updateTick", "(Lnet/minecraft/block/BlockStaticLiquid;Lnet/minecraft/world/World;IIILjava/util/Random;)V", false));
