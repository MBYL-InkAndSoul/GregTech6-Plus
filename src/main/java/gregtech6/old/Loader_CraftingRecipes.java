...
public class Loader_CraftingRecipes implements Runnable {
	...
	public void run() {
		...
		tStack = GT_Utility.getWrittenBook("GregTech6 Manual I (Edition 5)", "Gregorius Techneticies", new String[] {
				  "So, this is probably your first time using a Product of GregTech6 Intergalactical, so you might ask yourself where to begin with? This World is very complex, and you may want to aquire a few basic Resources first."
		...
		tStack = GT_Utility.getWrittenBook("GregTech6 Manual II", "Gregorius Techneticies", new String[] {
		...
		tStack = GT_Utility.getWrittenBook("GregTech6 Machine Safety (Edition 2)", "Gregorius Techneticies", new String[] {
		...
		tStack = GT_Utility.getWrittenBook("Greg-OS Manual I", "Gregorius Techneticies", new String[] {
				  "Redstone Circuits are the main Component of a well running Base. The GregTech6 Redstone Circuit Block is ideal for processing Logic. It can compute everything! From a simple and consistent Timer to the Combo Lock on your Door!"
		...
		tStack = GT_Utility.getWrittenBook("Upgrade Dictionary V4.04p", "Gregorius Techneticies", new String[] {
				  "This Book lists all Items, which can be used as special Upgrade for GregTech6 Machines. As Books are distributed via Worldgen, this Book can be outdated on older Maps (see Version Number on the Title)."
				...
				, "Overclocker Upgrades, as you know them from Industrial Corp, can be used to speed up Progress in GregTech6 Machines as well, but more efficiently. Every Overclocker doubles the Speed but also quadruples the required Voltage."
		...
		tStack = GT_Utility.getWrittenBook("GregTech6 Energy Systems V3.04b", "Gregorius Techneticies", new String[] {
				  "This Book explains Core Functionality of GregTech6 Machines. You might not understand it, but it can help you in some Cases."
				, "As you know, GregTech6 Machines can run on 4 diffrent Energy Systems. Energy Units and Universal Electricity are natively compatible without Upgrades and are stored in the Electric Capacity. MJ and Steam need Upgrades and have seperate Capacities."
				...
				, "Almost every Cover Upgrade, Generator or similar Device produces Electricity. Electricity is the only Energy, which can be outputted by GregTech6 Machines. Everything else will be stuck inside the Machine until it gets consumed."
		...
		tStack = GT_Utility.getWrittenBook("Printer Manual", "Gregorius Techneticies", new String[] {
				  "This Manual explains the different Functionalities the GregTech6 Printing Factory has built in. And there are LOTS of things this Device can do, and none of them is Documented via NEI."
