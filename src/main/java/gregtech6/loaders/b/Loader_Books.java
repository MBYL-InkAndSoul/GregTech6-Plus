...
public class Loader_Books implements Runnable {
	...
	public void run() {
		...
		UT.Books.createWrittenBook("Manual_Printer", "Scanner & Printer Manual", "GregTech6 Electrics", ST.make(ItemsGT.BOOKS, 1, 32000), new String[] {
		...
		UT.Books.createWrittenBook("Manual_Steam", "Steam Manual", "GregTech6 Thermodynamics", ST.make(ItemsGT.BOOKS, 1, 32000), new String[] {
		...
		UT.Books.createWrittenBook("Manual_Random", "Tips & Tricks with GregTech6 Six", "Gregorius Techneticies", ST.make(ItemsGT.BOOKS, 1, 32000), new String[] {
		...
		UT.Books.createWrittenBook("Manual_Portal_TF", "Benimatics Twilight Forest", "Gregorius Techneticies", ST.make(ItemsGT.BOOKS, 1, 5), new String[] {
		  "This Books existence means that you found a GregTech6 6 Dungeon with a Twilight Forest Portal inside of it, congratulations. If you don't know how to light the Portal to go on the Adventure, don't worry, in here are some instructions."
		...
		, "Endermen¶===================¶The Weakness Potion Effect is capable of preventing an Enderman from Teleporting, make use of that and splash them. (Note, that it is GregTech6 adding that Feature!)"
...
//      tBook.add("Sickles"             +"¶===================¶");
		...
		tBook.add("Magnifying Glasses"  +"¶===================¶With this you can look at the Details of a LOT of things in GregTech6, just put a Lens of any kind on a Stick and you are good to go for a long time.");
