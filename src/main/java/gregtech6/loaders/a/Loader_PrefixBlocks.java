...
public class Loader_PrefixBlocks implements Runnable {
	@Override
	public void run() {
		BlocksGT.blockRaw                   = new PrefixBlock_(MD.GT, "gt.meta.storage.raw"         , OP.blockRaw               , null                 , null, null, null                                              , Material.rock , Block.soundTypeGravel, TOOL_pickaxe, 1.5F, 4.5F,   0,   0, 999, 0,0,0,1,1,1, F,F,F,F,T,T,T,T,T,T,T,T,T,T, OreDictMaterial.MATERIAL_ARRAY);
