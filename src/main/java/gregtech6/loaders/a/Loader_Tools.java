...
import gregtech6.items.tools.guns.GT_Tool_Carbine;
import gregtech6.items.tools.guns.GT_Tool_Pistol;
import gregtech6.items.tools.guns.GT_Tool_Rifle;
import gregtech6.items.tools.machine.*;
import gregtech6.items.tools.pocket.*;
...
public class Loader_Tools implements Runnable {
	...
	public void run() {
		...
		ArmorsGT.HAZMATS_INSECTS    .add(ArmorsGT.HAZMAT_INSECTS    [0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.head"     , "Bumblehead"                       , "Full Set protects against any Insects"         , "hazard_insects"   , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RRR", "RGR", "q l", 'R', foil.dat(ANY.Rubber), 'G', ST.make(Blocks.stained_glass_pane, 1, 15-DYE_INDEX_Black)));
		ArmorsGT.HAZMATS_INSECTS    .add(ArmorsGT.HAZMAT_INSECTS    [1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.chest"    , "Bumbleshirt"                      , "Full Set protects against any Insects"         , "hazard_insects"   , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RqR", "RRR", "RRR", 'R', foil.dat(ANY.Rubber)));
		ArmorsGT.HAZMATS_INSECTS    .add(ArmorsGT.HAZMAT_INSECTS    [2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.legs"     , "Bumblepants"                      , "Full Set protects against any Insects"         , "hazard_insects"   , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RRR", "RqR", "RlR", 'R', foil.dat(ANY.Rubber)));
		ArmorsGT.HAZMATS_INSECTS    .add(ArmorsGT.HAZMAT_INSECTS    [3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.boots"    , "Bumbleboots"                      , "Full Set protects against any Insects"         , "hazard_insects"   , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RlR", "RqR"       , 'R', foil.dat(ANY.Rubber)));
		...
		ArmorsGT.HAZMATS_RADIOACTIVE.add(ArmorsGT.HAZMAT_RADIOACTIVE[3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.boots" , "Radiation Hazard Suit Boots"      , "Full Set protects against Radiation"           , "hazard_radiation" , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LlL", "LxL"       , 'L', plate.dat(MT.Pb)));
										 ...
										 ArmorsGT.HAZMAT_BIOCHEMGAS [0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.head" , "Biochemical Gas Hazard Suit Mask" , "Full Set protects against Chemicals and Gases" , "hazard_biochemgas", 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RRR", "RGR", "q l", 'R', plate.dat(ANY.Rubber), 'G', Blocks.glass_pane);
										 ArmorsGT.HAZMAT_BIOCHEMGAS [1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.chest", "Biochemical Gas Hazard Suit Shirt", "Full Set protects against Chemicals and Gases" , "hazard_biochemgas", 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RqR", "RRR", "RRR", 'R', plate.dat(ANY.Rubber));
										 ArmorsGT.HAZMAT_BIOCHEMGAS [2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.legs" , "Biochemical Gas Hazard Suit Pants", "Full Set protects against Chemicals and Gases" , "hazard_biochemgas", 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RRR", "RqR", "RlR", 'R', plate.dat(ANY.Rubber));
										 ArmorsGT.HAZMAT_BIOCHEMGAS [3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.boots", "Biochemical Gas Hazard Suit Boots", "Full Set protects against Chemicals and Gases" , "hazard_biochemgas", 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RlR", "RqR"       , 'R', plate.dat(ANY.Rubber));
...
//      ToolsGT.add(ToolIDs.sMetaTool.addTool(ToolIDs.SICKLE                    , "Sickle"                          , "Harvests Crops more efficiently"                     , new GT_Tool_Sickle()                                           .setMaterialAmount(3*U                                       ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GRANUM        , 2)                                ), TOOL_sickle);
		...
		for (OreDictMaterial tMaterial : new OreDictMaterial[] {MT.Syrmorite, MT.Au, MT.Al, MT.Cr, MT.StainlessSteel, MT.Netherite, MT.NetherizedDiamond})
		...
		for (OreDictMaterial tMaterial : ANY.Plastic.mToThis)
		CR.shaped(ToolsGT.sMetaTool.getToolWithStats(ToolsGT.ROLLING_PIN, tMaterial, tMaterial), CR.DEF_MIR, "  S", " I ", "S f", 'I', ingot.dat(tMaterial), 'S', stick.dat(tMaterial));
		
		
		for (Object[] tHandle : new Object[][] {{ANY.Wood, OD.stickAnyWood}, {MT.PetrifiedWood, stick.dat(MT.PetrifiedWood)}, {MT.Bamboo, OD.bamboo}, {MT.Bone, Items.bone}, {ANY.Plastic, stick.dat(ANY.Plastic)}}) {
		...
		toolHeadWrench             .addListener(new OreProcessing_Tool(PLUNGER               , tCategory + "Plunger"             ,F,F,0,0, null, new String[][] {{"xVV", " SV", "S f"}}                                              , null                                                                                , null         , null, null, plate.dat(ANY.Rubber)             , null, new And(ANTIMATTER.NOT, MT.Wood.NOT)));
		...
		toolHeadWrench             .addListener(new OreProcessing_Tool(PISTOL                , tCategory + "Pistols"             ,T,F,0,0, null, new String[][] {{"XXV", " TH", "d h"}}                                              , null                                                                                , plateCurved  , null, null, Items.flint                       , null, new And(ANTIMATTER.NOT, MT.Wood.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(2))));
		toolHeadWrench             .addListener(new OreProcessing_Tool(CARBINE               , tCategory + "Carbines"            ,T,F,0,0, null, new String[][] {{"XXV", "THH", "d h"}}                                              , null                                                                                , plateCurved  , null, null, Items.flint                       , null, new And(ANTIMATTER.NOT, MT.Wood.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(2))));
		toolHeadWrench             .addListener(new OreProcessing_Tool(RIFLE                 , tCategory + "Rifles"              ,T,F,0,0, null, new String[][] {{"XXX", "HHV", "dTh"}}                                              , null                                                                                , plateCurved  , null, null, Items.flint                       , null, new And(ANTIMATTER.NOT, MT.Wood.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(2))));
		...
		toolHeadHammer             .addListener(new OreProcessing_Tool(SOFTHAMMER            , tCategory + "SoftHammer"          ,T,F,0,0, null, null                                                                                , new String[][] {{"II ", "IIr", "II "}, {"GG ", "GGr", "GG "}                       }, null         , null, null, null                              , null, new And(ANTIMATTER.NOT, MT.Wood.NOT, COATED.NOT, new Or (WOOD, BOUNCY, STRETCHY), EXTRUDER.NOT)));
