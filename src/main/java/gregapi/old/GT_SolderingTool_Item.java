...
//      GregTech6_API.registerSolderingTool(ST.make(this, 1, W));
//      setCraftingSound(GregTech6_API.sSoundList.get(103));
//      setBreakingSound(GregTech6_API.sSoundList.get(103));
//      setEntityHitSound(GregTech6_API.sSoundList.get(103));
