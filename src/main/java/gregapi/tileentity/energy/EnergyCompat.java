...
public class EnergyCompat {
	...
	public static boolean canConnectElectricity(TileEntity aThis, TileEntity aTarget, byte aSide) {
		...
		if (aTarget instanceof gregtech6.api.interfaces.tileentity.IEnergyConnected) return ((gregtech6.api.interfaces.tileentity.IEnergyConnected)aTarget).inputEnergyFrom(aSide) || ((gregtech6.api.interfaces.tileentity.IEnergyConnected)aTarget).outputsEnergyTo(aSide);
	...
	public static long insertEnergyInto(TagData aEnergyType, byte aSide, long aSize, long aAmount, Object aEmitter, TileEntity aReceiver) {
		...
		if (aEnergyType == TD.Energy.EU) {
			...
			if (aReceiver instanceof gregtech6.api.interfaces.tileentity.IEnergyConnected) {
				return ((gregtech6.api.interfaces.tileentity.IEnergyConnected)aReceiver).injectEnergyUnits(aSide, aSize, aAmount);
			}
