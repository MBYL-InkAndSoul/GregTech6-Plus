	...
	public void onModPreInit2(FMLPreInitializationEvent aEvent) {
		try {
			...
			for (short i = 0; i < tModList.size(); i++) {
				...
				if (tMod.getModId().equalsIgnoreCase(MD.GAPI_POST.mID)) tGregTech6 = tMod; else tNewModsList.add(tMod);
			}
