					...
					for (ItemStack tOutput : tStacks) {
						if (OreDictManager.INSTANCE.isOreDictItem(tOutput)) {
							...
							if (CS.CODE_CLIENT) {
								...
								FMLLog.severe("GregTech6 just reports this Error to you, so you can report it to the Mod causing the Problem.");
								...
								FMLLog.severe("Both IC2 and GregTech6 CANNOT be the CAUSE of this Problem, so don't report it to either of them.");
								FMLLog.severe("I REPEAT, BOTH, IC2 and GregTech6 CANNOT be the source of THIS BUG. NO MATTER WHAT.");
